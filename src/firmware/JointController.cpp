...
void PLEN2::JointController::loadSettings()
{
    ...
    {
        #if DEBUG
            System::debugSerial().println(F("no saved settings"));
        #endif
    ...
    {
        #if DEBUG
            System::debugSerial().println(F("saved settings"));
        #endif
    ...
    for (uint8_t joint_id = 0; joint_id < JOINTS_SUM; joint_id++)
    {
        setAngle(joint_id, m_SETTINGS[joint_id].HOME);
        #if DEBUG
            System::debugSerial().print(joint_id, DEC);
            System::debugSerial().print(F(" => "));
            System::debugSerial().print(m_SETTINGS[joint_id].MIN, DEC);
            System::debugSerial().print(F(", "));
            System::debugSerial().print(m_SETTINGS[joint_id].MAX, DEC);
            System::debugSerial().print(F(", "));
            System::debugSerial().println(m_SETTINGS[joint_id].HOME, DEC);
        #endif
    }
